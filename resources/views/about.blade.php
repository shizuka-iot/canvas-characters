	...
	<div id="wrapper">
		...
		<main class="column center">
			...
			<div class="talk_wrapper">
				...
				<h3>質問に答えるとクリーチャーが生まれるんだけど！！</h3>
				<div class="character_talk row height_center">
					<img src="{{ asset('/imgs/fs05.png')}}" alt="">
					<div class="talk_message balloon-left">
						<p>
							「わからない」を選択するとランダムな値が選択されてクリーチャーが生まれる確率が上がるぜ！
							<br>
							確固たる意思を持って選択することが大切だ。
						</p>
					</div>
				</div>
				...
				<div class="character_talk row height_center">
					<img src="{{ asset('/imgs/fs05.png')}}" alt="">
					<div class="talk_message balloon-left">
						<p>すまねぇ……、俺達はまだ完成してねぇ。どんどんアップデートされる予定だ。<br>俺達だってこのままで終わるつもりはねぇ。もっと個性豊かなキャラクターズが生まれるはずだぜ。<br>要望があれば製作者のツイッターにメッセージ送ればいいと思うぜ。</p>
					</div>
				</div>
