...
class AnswerSeeder extends Seeder
{
	...
	private $answers_arr = [
		...
		['はい', 'いいえ', 'わからない', 'その他',], // 4
		['はい', 'いいえ', 'わからない', 'その他',], // 5
		['肉体派', '頭脳派', '両方の特性を兼ね備えたハイブリッド', 'どちらもないポンコツ',], // 19
		['はい', 'いいえ', 'わからない', 'その他',], // 6
		['はい', 'いいえ', 'わからない', 'その他',], // 7
		['はい', 'いいえ', 'わからない', 'その他',], // 9
		['0人', '1人', '2人以上5人未満', '5人以上',], // 10
		['雨に濡れそうで嫌だ', '風情があって好きだ', '雨は実は空気中の汚れを吸ってかなり汚れているのだ', 'その他',], // 11
		['人類', '最愛の人', 'どちらも選べない', 'どちらも救える方法を模索する',], // 12
		['おしゃれ', '実用性', 'どちらも同じ位重視する', 'なにも思わない',], // 13
		['恋仲を邪魔するのはいけないことだ。諦める', '好きな気持ちに嘘はつけない。告白する。', 'チャンスが訪れるのを我慢強く待つ', '手段を選ばず必ず手に入れる',], // 14
		['よくある', 'あまりない', '家には常に人がいる', 'そもそも外出しない',], // 15
		['重要以外のなにものでもない', '学歴はただの経歴に過ぎず能力こそ重要', 'わからない', 'ホイ卒ですが何か？',], // 16
		['はい', 'いいえ', 'わからない', 'その他',], // 17
		['はい', 'いいえ', 'わからない', 'その他',], // 18
		['はい', 'いいえ', 'わからない',], // 20
	];
